...
router.post("/:id/approve", requireAdmin, async (req, res) => {
  ...
  await ctrl.save();
  logFromReq(req, "APPROVE_CONTROLLER", {
    controllerId: ctrl._id,
    controllerName: ctrl.name,
    approvedEvents: ctrl.approvedEvents,
  });
  res.json(ctrl);
});
...
router.post("/:id/reject", requireAdmin, async (req, res) => {
  ...
  await ctrl.save();
  logFromReq(req, "REJECT_CONTROLLER", {
    controllerId: ctrl._id,
    controllerName: ctrl.name,
  });
...
router.post("/:id/revert", requireAdmin, async (req, res) => {
  ...
  ctrl.status = "PENDING";
  await ctrl.save();
  logFromReq(req, "REVERT_CONTROLLER", {
    controllerId: ctrl._id,
    controllerName: ctrl.name,
  });
...
router.post("/:id/revoke", requireAdmin, async (req, res) => {
  ...
  ctrl.approvedEvents = [];
  await ctrl.save();
  logFromReq(req, "REVOKE_CONTROLLER", {
    controllerId: ctrl._id,
    controllerName: ctrl.name,
  });
