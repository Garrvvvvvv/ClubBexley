...
export async function createEvent(req, res) {
  try {
    ...
    logFromReq(req, "CREATE_EVENT", { eventId: event._id, name: event.name, slug: event.slug });
...
export async function updateEvent(req, res) {
  try {
    ...
    logFromReq(req, "UPDATE_EVENT", { eventId: event._id, name: event.name });
    res.json(event);
  } catch (err) {
...
export async function deleteEvent(req, res) {
  try {
    ...
    logFromReq(req, "DELETE_EVENT", { eventId: deletedEvent._id, name: deletedEvent.name });
