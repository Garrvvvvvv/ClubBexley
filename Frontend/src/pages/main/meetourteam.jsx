...
const TEAM = [
  {
    ...
    name: "Rohan",
    role: "Founder",
    tagline: "Your Trip’s Main Man: Turning group chats into boarding passes.",
  ...
  },
  {
    ...
    tagline: "Making strangers catch flights and feelings.",
    funFact: "Flirts with vibes, not people",
