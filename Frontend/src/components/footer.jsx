...
export default function Footer() {
  ...
  // Centralized internal navigation handler
    ...
    <footer className="bg-black text-white font-sans">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              {[
                ...
                { name: "Become an Event Controller", path: "/controller/login" },
                { name: "Meet Our Developer", path: "/meetourdevelopers" },
              ].map((link) => (
                <li key={link.name}>
                  <button
                    onClick={() => handleNavigation(link.path)}
                    className="hover:text-[#ca0002] flex items-start transition-colors text-left w-full"
                  >
              ...
              {[
                ...
                <li key={idx}>
                  <a
                    ...
                    className="hover:text-[#ca0002] flex items-start transition-colors"
                  >
                    <span className="mr-2 text-gray-500">&gt;</span>
                    {link.name}
                  </a>
          ...
          <div>
            ...
            <div className="text-sm text-gray-300 space-y-4">
              ...
              <div>
                ...
                <a
                  href="mailto:headalumni@thapar.edu"
                  className="block hover:text-[#ca0002] transition-colors"
                >
                  headalumni@thapar.edu
                </a>
                <a
                  href="mailto:arctiet@thapar.edu"
                  className="block hover:text-[#ca0002] transition-colors"
                >
                  arctiet@thapar.edu
                </a>
              ...
              <div>
                ...
                <div className="flex space-x-3 mt-2">
                  <a href="https://www.instagram.com/arc_tiet/" target="_blank" rel="noopener noreferrer" className="bg-[#333] text-white p-2 rounded-full hover:bg-[#E1306C] transition-colors"><FaInstagram size={14} /></a>
                  <a href="https://www.linkedin.com/company/thapar-alumni-relations/" target="_blank" rel="noopener noreferrer" className="bg-[#333] text-white p-2 rounded-full hover:bg-[#0077b5] transition-colors"><FaLinkedinIn size={14} /></a>
                  <a href="https://www.youtube.com/@AlumniRelationsCellTIET" target="_blank" rel="noopener noreferrer" className="bg-[#333] text-white p-2 rounded-full hover:bg-[#FF0000] transition-colors"><FaYoutube size={14} /></a>
                  <a href="https://open.spotify.com/show/0Bu6ILKEXigkmP0fw82wm8" target="_blank" rel="noopener noreferrer" className="bg-[#333] text-white p-2 rounded-full hover:bg-[#1DB954] transition-colors"><FaSpotify size={14} /></a>
                </div>
              </div>
      ...
      <div className="bg-[#111] border-t border-gray-800 py-4">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
          <p>
            Copyright © 2026. Thapar Institute of Engineering & Technology. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
